    ...
    return (
        <>
            ...
            <div className="col-4" style={{ margin: "1rem" }}>
                ...
                <input type="number" name="" id="salary" aria-describedby="helpId" placeholder="" class="form-control" />
                <button onClick={RunPie} class="btn btn-success" style={{ margin: "1rem 0" }}>Submit</button>
